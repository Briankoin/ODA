...
class GVA_Elementor_Override{
   ...
   public function column_control($obj, $args){
      ...
      $obj->start_controls_section(
         'gva_column_control',
         array(
            'label' => esc_html__( 'Other Settings', 'conult-themer' ),
      ...
      $obj->add_responsive_control(
         ...
         [
            'label'     => __('Inner Width', 'conult-themer'),
   ...
   public function after_row_end( $obj, $args ) {
      ...
      $obj->start_controls_section(
         'gva_section_row',
         array(
            'label' => esc_html__( 'Gavias Extra Settings Row for Header Builder', 'conult-themer' ),
            'tab'   => Controls_Manager::TAB_LAYOUT,
         )
      );
      ...
      $obj->add_control(
         'row_header_sticky',
         [
            'label'  => esc_html__( 'Sticky Row Settings (Use only for row in header)', 'conult-themer' ),
      ...
      $obj->add_control(
         '_gva_sticky_menu',
         [
            'label'     => __( 'Sticky Menu Row', 'conult-themer' ),
            'type'      => Controls_Manager::SELECT,
            'options'   => [
               '' => __( '-- None --', 'conult-themer' ),
               'gv-sticky-menu' => __( 'Sticky Menu', 'conult-themer' ),
            ],
            'default'         => '',
            'prefix_class'    => '',
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Background Color', 'conult-themer'),
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Text Color', 'conult-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Link Menu Color', 'conult-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Link Menu Hover Color', 'conult-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
   ...
   public function row_style($obj, $args){
      ...
      $obj->start_controls_section(
         ...
         array(
            'label' => esc_html__( 'Gavias Style Settings', 'conult-themer' ),
      ...
      $obj->add_control(
         ...
         [
            'label'     => __( 'Style Available', 'conult-themer' ),
            'type'      => Controls_Manager::SELECT,
            'options'   => [
               ''                 => __( '-- None --', 'conult-themer' ),
            ],
      ...
      $obj->add_control(
         ...
         [
            ...
            'label_block'  => true,
            'options' => [
               '' => __( '-- Default --', 'conult-themer' ),
               'theme'         => __( 'Background Color Theme', 'conult-themer' ),
               'theme-second'  => __( 'Background Color Theme Second', 'conult-themer' ),
            ],
            'default' => '',
            'prefix_class' => 'bg-row-',
         ]
