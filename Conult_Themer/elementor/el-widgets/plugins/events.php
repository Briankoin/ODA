...
class GVAElement_Events extends GVAElement_Base{
	...
	public function get_title() {
		return __('GVA Events', 'conult-themer');
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'event_start_date' => __( 'Event Start Date', 'conult-themer' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'event-1'     => __( 'Event Item Style I', 'conult-themer' )
				],
				'default' => 'event-1',
				'condition' => [
	...
	public static function get_query_args(  $settings ) {
		...
		if($cats){
          ...
          $query_args['post_type'] = array('tribe_events');
      }
