...
class GVAElement_Posts extends GVAElement_Base{
	 ...
	 public function get_title() {
		  return __('Posts All Items', 'conult-themer');
	 }
	 ...
	 protected function register_controls() {
		  ...
		  $this->add_control( // xx Layout
			...
			$this->add_control(
				...
				[
					 ...
					 'default' => 'carousel',
					 'options' => [
						  'standard'      => __('Standard', 'conult-themer'),
						  'grid'          => __('Grid', 'conult-themer'),
						  'carousel'      => __('Carousel', 'conult-themer'),
						  'small_list'    => __('Small List', 'conult-themer'),
						  'sticky'        => __('Post Large & List', 'conult-themer')
					 ]
				]
		  );
		  $this->add_control(
				...
				[
					 ...
					 'options' => [
						  'post-style-1'         => __('Item Post Style I', 'conult-themer'),
						  'post-style-2'         => __('Item Post Style II', 'conult-themer'),
					 ],
					 'condition' => [
		  	...
		  	$this->add_control(
				'excerpt_words',
				[
					'label'     => __('Excerpt Words', 'conult-themer'),
					'type'      => 'number',
					'default'   => 15
				]
		  	);
		  	...
		  	$this->start_controls_section(
				...
				[
					'label' => __('Right List Posts Style', 'conult-themer'),
		  	...
		  	$this->add_responsive_control(
				'stick_list_padding',
				[
					'label' => __('Padding List Posts', 'conult-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('Background List Posts', 'conult-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Title Color', 'conult-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Meta Color', 'conult-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  ...
		  $this->start_controls_section(
				...
				[
					 'label' => __('Post Description', 'conult-themer'),
					 'tab'   => Controls_Manager::TAB_STYLE,
					 'condition' => [
						  'layout' => ['grid', 'carousel']
					 ],
