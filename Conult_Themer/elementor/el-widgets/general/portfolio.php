...
class GVAElement_Portfolio extends GVAElement_Base{
    ...
    public function get_title() {
        return esc_html__('Portfolio', 'conult-themer');
    }
    ...
    private function get_categories_list(){
        ...
        $categories['none'] = esc_html__('None', 'conult-themer');
    ...
    private function get_posts() {
        ...
        $posts['none'] = esc_html__('None', 'conult-themer');
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_query',
            [
                'label' => esc_html__('Query & Layout', 'conult-themer'),
        ...
        $this->add_control(
            'category_ids',
            [
                'label' => esc_html__('Select By Category', 'conult-themer'),
        ...
        $this->add_control(
            'post_ids',
            [
                'label' => esc_html__('Select Individually', 'conult-themer'),
                'type' => Controls_Manager::SELECT2,
                'default' => '',
                'multiple'    => true,
                'label_block' => true,
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => esc_html__('Posts Per Page', 'conult-themer'),
        ...
        $this->add_control(
            'orderby',
            [
                'label'   => esc_html__('Order By', 'conult-themer'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'conult-themer'),
                    'post_title' => esc_html__('Title', 'conult-themer'),
                    'menu_order' => esc_html__('Menu Order', 'conult-themer'),
                    'rand'       => esc_html__('Random', 'conult-themer'),
                ],
            ]
        );
        ...
        $this->add_control(
            'order',
            [
                'label'   => esc_html__('Order', 'conult-themer'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'desc',
                'options' => [
                    'asc'  => esc_html__('ASC', 'conult-themer'),
                    'desc' => esc_html__('DESC', 'conult-themer'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'portfolio-style-1'         => esc_html__('Item Portfolio Style I', 'conult-themer'),
                    'portfolio-style-2'         => esc_html__('Item Portfolio Style II', 'conult-themer'),
                    'portfolio-style-3'         =>esc_html__('Item Portfolio Style III', 'consult-themer')
                ],
                'condition' => [
        ...
        $this->add_control(
            'content_max_width',
            [
               'label'     => esc_html__('Content Width', 'conult-themer'),
        ...
        $this->add_control(
            'isotope_filter',
            [
                'label'     => esc_html__('Isotope Filter', 'conult-themer'),
        ...
        $this->add_control(
            'pagination',
            [
                'label'     => esc_html__('Pagination', 'conult-themer'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'no',
                'condition' => [
                    'layout' => 'grid'
