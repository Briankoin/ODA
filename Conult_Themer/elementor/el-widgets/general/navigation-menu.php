...
class GVAElement_Navigation_Menu extends GVAElement_Base {
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Navigation Menu', 'conult-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'sub_menu_min_width',
			[
				'label' => __( 'Submenu Min Width (px)', 'conult-themer' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Main Menu', 'conult-themer' ),
		...
		$this->add_control(
			'menu_top_line_color',
			[
				'label'     => __('Top Line Color', 'conult-themer'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'main_menu_padding',
			[
				'label' => __( 'Menu Item Padding', 'conult-themer' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Sub Menu', 'conult-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __('Link Color', 'conult-themer'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
