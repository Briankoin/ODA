...
class GVAElement_Post_Tags extends GVAElement_Base{
	 ...
	 public function get_title(){
		  return esc_html__('Post Tag', 'conult-themer');
	 }
	 ...
	 protected function register_controls(){
		...
		$this->add_control(
			...
			[
				...
				'default'      => esc_html__( 'Tags', 'conult-themer' ),
				'label_block'  => true
			]
		);
		...
		$this->add_control(
			'heading_style_title',
			[
				'label' => esc_html__( 'Style Title Text', 'conult-themer' ),
		...
		$this->add_control(
			'title_color',
			[
				'label' => esc_html__( 'Text Color', 'conult-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .conult-post-tags .title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .conult-post-tags .title',
			]
		);
