	 ...
	 <div class="box-content">
		<div class="content-inner">
			...
			<?php if(!empty($settings['link']['url'])){ ?>
			  <div class="read-more">
				 <?php $this->gva_render_link_html('<span>' . esc_html__( 'Read More', 'conult-themer' ) . '</span>', $settings['link'], 'btn-inline'); ?>
			  </div>
			<?php } ?>
		</div>	
	 </div>  
  ...
  <div <?php echo $this->get_render_attribute_string( 'block' ) ?>>
	 <div class="box-content">
		<div class="content-inner">
			...
			<?php if(!empty($settings['link']['url'])){ ?>
			  <div class="read-more">
				 <?php $this->gva_render_link_html('<span>' . esc_html__( 'Read More', 'conult-themer' ) . '</span>', $settings['link'], 'btn-white'); ?>
			  </div>
			<?php } ?>
		</div>
		<?php if(!empty($settings['image']['url'])){ ?>
