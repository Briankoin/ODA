<?php 
   ...
   $image = '<img ' . $this->conult_get_image_size($image_url) . ' src="' . esc_url($image_url) . '" alt="' . esc_html($image_alt) . '" />';
   	...
   	<?php if($image_url){ ?>
   		<div class="team-image">
            ...
            <div class="socials-team">
               <?php $this->gva_render_link_html_2('<i class="fa fa-linkedin"></i>', $item['linkedin']) ?>
