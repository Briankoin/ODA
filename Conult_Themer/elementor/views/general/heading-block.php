<?php
   ...
   <div <?php echo $this->get_render_attribute_string( 'block' ) ?>>
      <div class="content-inner">
         ...
         <?php 
            if($settings['heading_line'] == 'yes'){ 
               echo '<div class="heading-line"><span></span><span></span></div>';
            }
         ?>

         <?php if($sub_title){ ?>
            <div <?php echo $this->get_render_attribute_string( 'sub_title' ); ?>>
               <span class="tagline"><?php echo esc_html($sub_title); ?></span> 
            </div>
         <?php } ?>  
