      ...
      if($post && $post->post_type === 'gva__template'){
         ...
         if($template_type == 'header_layout'){
            $document->add_control(
               'conult_header_position',
               [
                  'label'     => esc_html__('Header Position', 'conult-themer'),
                  'type'      => Controls_Manager::SELECT,
                  'options'   => array(
                     'relative'  => esc_html__('Relative', 'conult-themer'),
                     'absolute'  => esc_html__('Absolute', 'conult-themer'),
                  ),
                  'default' => 'relative',
               ]
            );
            $document->add_control(
               ...
               [
                  'label' => esc_html__('Background Black Demo', 'conult-themer'),
         ...
         if($show_preview){
            $document->add_control(
               'conult_post_preview',
               [
                  'label'     => esc_html__('Preview Content', 'conult-themer'),
                  'type'      => Controls_Manager::SELECT,
