...
class Gavias_Themer_Template{
	...
	public function args_post_type_template(){
		$labels = array(
			'name'               => esc_html__( 'Template', 'conult-themer' ),
			'singular_name'      => esc_html__( 'Template', 'conult-themer' ),
			'add_new'            => esc_html__( 'Add Template', 'conult-themer' ),
			'add_new_item'       => esc_html__( 'Add Template', 'conult-themer' ),
			'edit_item'          => esc_html__( 'Edit Template', 'conult-themer' ),
			'new_item'           => esc_html__( 'New Template', 'conult-themer' ),
			'view_item'          => esc_html__( 'View Template', 'conult-themer' ),
			'search_items'       => esc_html__( 'Search Template Profiles', 'conult-themer' ),
			'not_found'          => esc_html__( 'No Template Profiles found', 'conult-themer' ),
			'not_found_in_trash' => esc_html__( 'No Template Profiles found in Trash', 'conult-themer' ),
			'parent_item_colon'  => esc_html__( 'Parent Template:', 'conult-themer' ),
			'menu_name'          => esc_html__( 'Templates & Layout', 'conult-themer' ),
		);
