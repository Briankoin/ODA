...
function conult_themer_get_theme_option($key, $default = ''){
  $conult_theme_options = get_option( 'conult_theme_options' );
  if(isset($conult_theme_options[$key]) && $conult_theme_options[$key]){
     return $conult_theme_options[$key];
  }else{
     return $default;
  }
  return false;
